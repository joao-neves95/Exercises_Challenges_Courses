...
namespace Yld.GamingApi.WebApi.Client
{
    ...
    public partial interface IClient
    {
        ...
        System.Threading.Tasks.Task<GamesResponse> GamesAsync(int? offset = null, int? limit = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class Client : IClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GamesResponse> GamesAsync(int? offset = null, int? limit = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GamesResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class GameResponse
    {
        ...
        public static GameResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GameResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class GamesResponse
    {
        ...
        public System.Collections.Generic.ICollection<GameResponse> Items { get; set; }
        ...
        public static GamesResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GamesResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class PlatformsResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("linux", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static PlatformsResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<PlatformsResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
