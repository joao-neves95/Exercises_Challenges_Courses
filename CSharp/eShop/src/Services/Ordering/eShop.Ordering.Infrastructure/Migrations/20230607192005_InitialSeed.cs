    ...
    public partial class InitialSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataBillingInformation", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DataPaymentInformation",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataPaymentInformation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_DataBillingInformation_BillingInformationId",
                        column: x => x.BillingInformationId,
                        principalTable: "DataBillingInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_DataPaymentInformation_PaymentInformationId",
                        column: x => x.PaymentInformationId,
                        principalTable: "DataPaymentInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
