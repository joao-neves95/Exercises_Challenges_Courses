...
namespace WebServer.Lib.Data
{
    ...
    public class MySqlObjects
    {
        ...
        public static List<Dictionary<string, object>> Query(MySqlConnection connection, MySqlCommand sqlCommand)
        {
            return ExecuteQuery(connection, sqlCommand);
        }

        public static List<Dictionary<string, object>> Query(MySqlConnection connection, string queryString)
        {
            MySqlCommand cmd = new MySqlCommand(queryString, connection);
            return ExecuteQuery(connection, cmd);
        }

        public static List<Dictionary<string, object>> Query(MySqlConnection connection, string queryString, Dictionary<string, object> parameters)
        {
            MySqlCommand cmd = new MySqlCommand(queryString, connection);
        ...
        private static List<Dictionary<string, object>> ExecuteQuery(MySqlConnection connection, MySqlCommand cmd)
        {
            try {
                connection.Open();
                using (connection) {
                    MySqlDataReader reader = cmd.ExecuteReader();
                    List<Dictionary<string, object>> recordset = new List<Dictionary<string, object>>();
        ...
        private static Dictionary<string, object> GetRowObject(MySqlDataReader reader)
        {
