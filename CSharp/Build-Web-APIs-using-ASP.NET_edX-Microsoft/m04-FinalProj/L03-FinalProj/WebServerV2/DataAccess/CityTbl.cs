...
namespace WebServer.DataAccess
{
    ...
    {
        public static List<Dictionary<string, object>> GetAllCities(MySqlConnection connection)
        {
        ...
        public static List<Dictionary<string, object>> GetCityById(MySqlConnection connection, int id)
        {
            ...
            return MySqlObjects.Query(connection, query);    
        }

        public static List<Dictionary<string, object>> GetCityByCountryCode(MySqlConnection connection, string countryCode)
        {
            MySqlCommand query = new MySqlCommand(
                @"SELECT *
                  FROM City
