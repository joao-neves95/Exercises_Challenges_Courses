...
SQL Countries List: https://github.com/seegatesite/country-db-mysql-list/blob/master/mysql_country_list.sql
Fake Name Generator: http://www.fakenamegenerator.com/
Credit Card Generator: http://credit-card-generator.2-ee.com/
IP Address Ranges by Country: http://lite.ip2location.com/ip-address-ranges-by-country
...
insert into `country` (`country_code`, `country_name`) values('', 'GUEST');
...
INSERT INTO user VALUES
    (NULL, 'GUEST', 'USER', CURRENT_TIMESTAMP, 5, CURDATE(), NULL, 246, 'GUEST USER'),
    (NULL, 'Martha', 'Russell', CURRENT_TIMESTAMP, 2, '1984-12-22', '7142629128', 230, '2475 Parkview Drive Los Angeles, CA 90017, United States'),
    (NULL, 'Joe', 'Hamilton', CURRENT_TIMESTAMP, 1, '1966-8-27', '07822042215', 229, 'Danemead, Hoddesdon, EN11 9LU, United Kingdom'),
    (NULL, 'José', 'Socrates', CURRENT_TIMESTAMP, 1, '1957-7-06', '961956686', 177, 'Rua da Bobadela, N. 2, Rés do Chão, Lisboa, Portugal'),
    (NULL, 'Christine', 'Gauvin', CURRENT_TIMESTAMP, 2, '1982-12-28', '+330294755991', 72, '86, Rue Petite Fusterie, 29200 BREST, France'),
    (NULL, 'Ricardo', 'Salgado', CURRENT_TIMESTAMP, 1, '1944-6-25', '912988956', 177, 'Fortunastrasse 41, Eschenmosen, 8180, Switzerland');

INSERT INTO auth VALUES
    (NULL, 1, 'noreply@gmail.com', 'amaguest', SHA2('1d0n_t-N33d.4.p4SS!w0RD?', 512)),
    (NULL, 2, 'martharu@gmail.com', 'marthaR', SHA2('ael4Ohn8aang', 512)),
    (NULL, 3, 'joehamilton@dayrep.com', 'afteptelle', SHA2('chai8Asong', 512)),
    (NULL, 4, 'ursofofinho@live.com', 'ursinho1957', SHA2('corrupção', 512)),
    (NULL, 5, 'gauvinchristy@gmail.com', 'christy82', SHA2('password', 512)),
    (NULL, 6, 'salgadinhoseumajola@gmail.com', 'salgaduXXX', SHA2('seraQmApanham?', 512));

INSERT INTO shipping_address VALUES
    (NULL, 2, '2475 Parkview Drive Los Angeles, CA 90017, United States'),
    (NULL, 3, 'Danemead, Hoddesdon, EN11 9LU, United Kingdom'),
    (NULL, 4, 'Rua da Bobadela, N. 2, Rés do Chão, Lisboa, Portugal'),
    (NULL, 5, '86, Rue Petite Fusterie, 29200 BREST, France'),
    (NULL, 4, 'Rua Encantada, Nº16, 2. Esquerdo, Lisboa, Portugal'),
    (NULL, 5, '66 Rue Jean Vilar, BELFORT, 90000 France'),
    (NULL, 6, 'Rua Bónita, N.17, 8. Frente, Lisboa, Portugal');

INSERT INTO accepted_method VALUES
    (NULL, 'Visa'),
    (NULL, 'Master Card'),
    (NULL, 'American Express'),
    (NULL, 'PayPal');

INSERT INTO pay_method VALUES
    (NULL, 2, 2, '5234 6658 6029 5648', '052', '10/18'),
    (NULL, 3, 1, '4916 9120 4800 9758', '289', '07/22'),
    (NULL, 4, 4, 'ursofofinho@live.com', NULL, NULL),
    (NULL, 5, 1, '4916 7826 1641 4742', '232', '06/20'),
    (NULL, 6, 1, '4916 4993 7885 4946', '635', '09/19'),
    (NULL, 4, 1, '4024 0071 0328 5374', '194', '03/18');

INSERT INTO product VALUES
    (NULL, 'Levis Pants, S', '', 110.98, 3),
    (NULL, 'Levis Pants, M', '', 110.98, 15),
    (NULL, 'Levis Pants, L', '', 110.98, 12),
    (NULL, 'Adidas Jacket, S', '', 56.99, 3),
    (NULL, 'Adidas Jacket, M', '', 56.99, 19),
    (NULL, 'Adidas Jacket, L', '', 56.99, 1),
    (NULL, 'A Confiança no Mundo', 'Best-Seller', 17.97, 30000);

/* SIMULATING LOG DATA: */
INSERT INTO logs VALUES
    (NULL, 2, '2.23.165.255', CURRENT_TIMESTAMP, 1),
    (NULL, 2, '2.23.165.255', CURRENT_TIMESTAMP, 2),
    (NULL, 3, '2.21.155.255', CURRENT_TIMESTAMP, 1),
    (NULL, 3, '2.21.155.255', CURRENT_TIMESTAMP, 2),
    (NULL, 4, '23.222.239.255', CURRENT_TIMESTAMP, 1),
    (NULL, 4, '23.222.239.255', CURRENT_TIMESTAMP, 2),
    (NULL, 5, '2.16.120.255', CURRENT_TIMESTAMP, 1),
    (NULL, 5, '2.16.120.255', CURRENT_TIMESTAMP, 2),
    (NULL, 6, '5.153.247.255', CURRENT_TIMESTAMP, 1),
    (NULL, 6, '5.153.247.255', CURRENT_TIMESTAMP, 2),
    (NULL, 2, '2.23.161.255', TIMESTAMPADD(DAY, 2, CURRENT_TIMESTAMP), 1),
    (NULL, 2, '2.23.161.255', TIMESTAMPADD(DAY, 2, CURRENT_TIMESTAMP), 2);
