...
import "../../../../Interfaces/External/_degen/ICupidMasterChef.sol";

import "../../LockedStratSingleAssetNoCompBase.sol";

contract LockedSaNcCupid is LockedStratSingleAssetNoCompBase {
    ...
    function getPendingRewardAmount() override external view returns (uint256) {
        return ICupidMasterChef(chefAddress).pendingArrows( poolId, address(this) );
    }
}
